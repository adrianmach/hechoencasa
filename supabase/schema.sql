...
insert into site_config (key, value) values
  ...
  ('contact', '{"whatsapp": "59892452415", "instagram": "@Hecho_en_casa_dulces", "tiktok": "@Hecho_en_casa_dulces", "email": "", "delivery_zone": "Montevideo y zona metropolitana", "hours": "Consultanos por WhatsApp", "neighborhood": "Montevideo"}'::jsonb),
  ('delivery', '{"modality": "Retiro en domicilio y envío a domicilio", "cadete_note": "También aceptamos que envíes tu propio cadete (PedidosYa, etc.), únicamente para retiro de alfajores.", "lead_time_tortas": "15 días de anticipación", "lead_time_postres": "5 días de anticipación", "lead_time_alfajores": "48 horas de anticipación", "urgencias_note": "¿Es urgente? Consultanos igual, a veces podemos hacer una excepción.", "payment_methods": ["Efectivo", "Transferencia bancaria", "Mercado Pago"]}'::jsonb),
  ('faq', '[{"question": "¿Con cuánta anticipación tengo que hacer el pedido?", "answer": "Tortas personalizadas: 15 días. Postres: 5 días. Alfajores: 48 horas. Si tenés una urgencia, consultanos igual, a veces podemos hacer una excepción."}, {"question": "¿Hacen envíos?", "answer": "Sí, hacemos retiro y envío a domicilio en Montevideo y zona metropolitana. También podés mandar tu propio cadete (PedidosYa, etc.), pero únicamente para retiro de alfajores."}, {"question": "¿Qué medios de pago aceptan?", "answer": "Efectivo, transferencia bancaria y Mercado Pago."}, {"question": "¿Puedo enviar una foto de referencia para mi torta?", "answer": "Sí, podés enviarla por WhatsApp junto con tu pedido de presupuesto."}, {"question": "¿Los precios incluyen envío?", "answer": "No, el envío se coordina y cotiza aparte por WhatsApp."}]'::jsonb),
  ('quote_form', '{"tortaSizes": ["10 porciones", "15 porciones", "20 porciones", "25+ porciones"], "postreSizes": ["14 cm", "20 cm", "26 cm"], "fillings": ["Dulce de leche", "Chocolate", "Frutas", "Crema", "Mousse"], "coatings": ["Buttercream", "Fondant", "Ganache", "Crema", "Sin cobertura"]}'::jsonb)
